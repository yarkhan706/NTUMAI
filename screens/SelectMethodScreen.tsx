      ...
      >
        <View className="flex-1 bg-white">
          ...
          <View className="px-6 pt-20 pb-6">
            <Text className="text-teal-600 text-5xl font-bold mb-1 leading-tight">Get Started!</Text>
          ...
          <View className="px-6 pb-12">
            <Pressable onPress={() => navigation.navigate('Login')}>
              <Text className="text-gray-600 text-base text-center leading-relaxed">
                Already have account? <Text className="text-teal-600 font-bold">Login to Continue</Text>
              </Text>
            </Pressable>
          </View>
